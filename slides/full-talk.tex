...
\begin{itemize}
\item \todo{look at Jarrod's slides - why python?}
\end{itemize}
...
\begin{itemize}
\item Permute tags within rows, independently across rows and across strata.
\item Compute $\rho_s$ and the corresponding p-value $P_s$, for $s = 1, \dots, S$.
\item For overall test of tag, the NPC test statistic is
...
\vspace{20pt}
\textbf{We} have to build the tools to
\begin{itemize}
\itemsep5pt
