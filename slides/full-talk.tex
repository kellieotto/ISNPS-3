...
\begin{center}
\begin{figure}[htbp]
\includegraphics[width=\textwidth]{fig/google_trends/pypl.png}
\end{figure}
{Keyword: how to}
\end{center}
...
\begin{center}
\begin{figure}[htbp]
\includegraphics[width=\textwidth]{fig/google_trends/dataanalysis}
\end{figure}
...
\begin{center}
\begin{figure}[htbp]
\includegraphics[width=\textwidth]{fig/google_trends/datascience}
\end{figure}
...
\begin{enumerate}
\item $N_m$ students are randomly assigned to the male TA, $N_f$ to the female TA
...
$${{N_m}\choose{N_{mm}} }\times{ {N_f}\choose{N_{fm}}}$$
...
$X^2 \sim \chi_{2J}^2$ if $\{ P_j\}_{j=1}^J$ are independent and all nulls are true. \\
\vspace{10pt}
}
...
\frame{
\frametitle{Omnibus Test}
Ratings for different categories are \textbf{dependent}.\\
\vspace{20pt}
$\implies$ Calibrate the distribution of $X^2$ using the permutation distributions of each individual statistic.
\vspace{10pt}
\begin{itemize}
\item Calculate the vector of observed values of test statistics (use the \textbf{same permutation} of students to compute each statistic)
\item Apply the combining function to get a single test statistic $X^2$ (or other) for the permutation.
\item Repeat a large number $B$ times to find the permutation distribution of $X^2$.
\end{itemize}
...
\item The male-identified TA was rated significantly higher than the female-identified TA on several dimensions, \textbf{even on objective measures} such as how promptly assignments were returned
...
\begin{figure}
\centering
\includegraphics[height=0.8\textheight]{fig/irr/perm1}
\end{figure}
}
...
\begin{figure}
\centering
\includegraphics[height=0.8\textheight]{fig/irr/perm2}
\end{figure}
}
\frame{
\frametitle{Inter-rater reliability test}
...
\begin{figure}
\centering
\includegraphics[height=0.8\textheight]{fig/irr/perm3}
\end{figure}
}
...
\frame{
\frametitle{Isn't data science just statistics?}

If we want to 
\begin{itemize}
\item facilitate reproducible research,
\item enable people to easily use the methods we develop, and
